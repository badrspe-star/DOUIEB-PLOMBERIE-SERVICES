          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-extrabold text-[#1a2e05] leading-tight tracking-tight uppercase">AMD PLOMBERIE</span>
                <span className="text-xs font-semibold text-[#6fc201] tracking-wider uppercase">Chiconi Mayotte</span>
              </div>
            </Link>
          </div>

      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="max-w-2xl flex-1">
            <div className="inline-flex items-center space-x-2 bg-[#f0f9e6] border border-[#6fc201]/20 px-3 py-1 rounded-full mb-6">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-[#1a2e05] leading-tight mb-6">
          ...
          <div className="flex-1 w-full lg:w-auto">
            <div className="relative">
              ...
              <div className="absolute inset-0 gradient-brand rounded-[2rem] rotate-3 scale-105 opacity-10"></div>
              <div className="absolute -inset-2 bg-[#6fc201]/5 rounded-[2.5rem] -rotate-2"></div>
              ...
              <img 
                ...
                className="relative z-10 w-full h-[450px] lg:h-[550px] object-cover rounded-[2rem] shadow-2xl border-4 border-white"
              />
              
              {/* Floating badge for trust */}
              <div className="absolute -bottom-6 -left-6 z-20 bg-white p-4 rounded-2xl shadow-xl border border-[#f0f9e6] hidden sm:flex items-center space-x-3">
